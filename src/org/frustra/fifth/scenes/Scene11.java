...
public class Scene11 extends Scene {
	...
	public void onStart() {
		...
		quotes = new QuoteLine[] {
			new QuoteLine("\"'Do you know who I think you are, Ramsay?", false),
			new QuoteLine("I think you are Fifth Business.' ...", false),
			new QuoteLine("'Are you Fifth Business? You had better find out.'\"", false),
			new QuoteLine("", false),
