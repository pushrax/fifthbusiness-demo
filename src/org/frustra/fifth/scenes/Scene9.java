...
public class Scene9 extends Scene {
	...
	public void onStart() {
		...
		quotes = new QuoteLine[] {
			new QuoteLine("\"You are now thirty-four, without wife or child,", false),
			new QuoteLine("and no better plan than your own whim; ...", false),
			new QuoteLine("Wake up, man! You are dreaming your life away!\"", false),
			new QuoteLine("", false),
